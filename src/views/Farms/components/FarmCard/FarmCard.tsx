...
const FarmCard: React.FC<FarmCardProps> = ({ farm, displayApr, removed, cakePrice, account }) => {
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('BELI', '')
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('BEFX + Fees')
  ...
  const isPromotedFarm = farm.token.symbol === 'BEFX'
