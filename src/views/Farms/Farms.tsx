    ...
    <FarmsContext.Provider value={{ chosenFarmsMemoized }} >
      ...
      <PageHeader>
        <Heading as="h1" scale="xxl" color="secondary" mb="24px">
          {t('Beliswap Liquidity Farm')}
        </Heading>
        <Heading scale="lg" color="text">
          {t('Stake $BEFX Liquidity Pool (LP) tokens to earn your favorite tokens....')}
        </Heading>
        <Heading scale="lg" color="text">
          {t('More will be launched in the near future.')}
        </Heading>
      ...
      <Page>
        ...
        <div ref={observerRef} />
        <StyledImage src="/images/decorations/BEFX3Dv2.png" alt="Pancake illustration" width={120} height={103} />
      </Page>
