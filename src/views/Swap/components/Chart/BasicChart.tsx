...
const BasicChart = ({
  ...
  return (
    <>
      ...
      <div id="dexscreener-embed" style={{ width: "100%", height: "85%" }}><iframe src={`https://dexscreener.com/bsc/${pairId}?embed=1&theme=dark&trades=0&info=0`} style={{ width: "100%", height: "100%" }}></iframe></div>
