        ...
        <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
          <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
            <Heading as="h1" scale="xxl" color="secondary" mb="24px">
              {t('Staking Pools on BeliSwap')}
            </Heading>
            <Heading scale="md" color="text">
              {t('Stake $BEFX to earn the tokens you desire the most.')}
            </Heading>
            <Heading scale="md" color="text">
              {t('You can unstake at any time, any place and be free to do whatever you want.')}
            </Heading>
            <Heading scale="md" color="text">
              {t('All rewards are calculated per block.')}
            </Heading>
          </Flex>
          <img src="/images/image.png" width="180px" alt="" />
        </Flex>
      </PageHeader>
      <Page>
        <video
        ...
        <Image
          mx="auto"
          mt="12px"
          src="/images/decorations/BEFX3Dv2.png"
